...
ReactDOM.render(
  <Router>
    <Switch>
      ...
      <Route exact path="/:id/records/:uid" component={Records} />
      <Route exact path="/:id/recordDemo/:uid" component={RecordDemo} />
      <Route exact path="/:id/recordUserList" component={RecordUserList} />
      <Route exact path="/:id/confirm/:uid" component={Confirm} />
